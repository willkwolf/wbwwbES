...
function() {
    ...
    Ticker.addEventListener = function() {
        return !Ticker._inited && Ticker.init(),
    ...
    Ticker.init = function() {
        Ticker._inited || (Ticker._inited = !0,
        Ticker._times = [],
        Ticker._tickTimes = [],
    ...
    Ticker.getMeasuredFPS = function(a) {
        var b = Ticker._times;
        return !b || b.length < 2 ? -1 : (a = Math.min(b.length - 1, a || 0 | Ticker.getFPS()),
        1e3 / ((b[0] - b[a]) / a))
    }
    ,
    ...
    Ticker._setupTick = function() {
        if (null == Ticker._timerId) {
            ...
            if (a == Ticker.RAF_SYNCHED || a == Ticker.RAF) {
                ...
                if (b)
                    return Ticker._timerId = b(a == Ticker.RAF ? Ticker._handleRAF : Ticker._handleSynch),
                    void (Ticker._raf = !0)
            }
            Ticker._raf = !1,
    ...
    Ticker._tick = function() {
        ...
        if (Ticker._lastTime = b,
        Ticker._ticks++,
        a && (Ticker._pausedTicks++,
        Ticker._pausedTime += c),
...
function() {
    ...
    Tween._register = function(a, b) {
        ...
        if (b && !a._registered)
            ...
            d.push(a),
            !Tween._inited && createjs.Ticker && (createjs.Ticker.addEventListener("tick", Tween),
            Tween._inited = !0);
    ...
    a.setPaused = function(a) {
        return this._paused === !!a ? this : (this._paused = !!a,
    ...
    a._appendQueueProps = function(a) {
        ...
        for (var g in a)
            if (void 0 === this._initQueueProps[g]) {
                ...
                c = this._curQueueProps[g];
        for (var g in a) {
            if (c = this._curQueueProps[g],
            b = Tween._plugins[g])
                for (f = f || {},
                d = 0,
                e = b.length; e > d; d++)
        ...
        return f && this._appendQueueProps(f),
        this._curQueueProps
    }
    ,
...
function() {
    ...
    MotionGuidePlugin.step = function(a, b, c, d, e) {
        if ("rotation" == b && (a.__rotGlobalS = c,
        a.__rotGlobalE = d,
        ...
        var h = g.path;
        if (g.hasOwnProperty("end") || (g.end = 1),
        g.hasOwnProperty("start") || (g.start = c && c.hasOwnProperty("end") && c.path === h ? c.end : 0),
        ...
        for (var k = 2; i > k; k += 4) {
            for (var l, m, n = h[k - 2], o = h[k - 1], p = h[k + 0], q = h[k + 1], r = h[k + 2], s = h[k + 3], t = n, u = o, v = 0, w = [], x = 1; j >= x; x++) {
                ...
                v += w[w.push(Math.sqrt((f = l - t) * f + (f = m - u) * f)) - 1],
                t = l,
                u = m
            }
            g._segments.push(v),
        ...
        g.orient = !0;
        var A = {};
        return MotionGuidePlugin.calc(g, g.start, A),
    ...
    MotionGuidePlugin.tween = function(a, b, c, d, e, f, g) {
        var h = e.guide;
        if (void 0 == h || h === d.guide)
            return c;
        if (h.lastRatio != f) {
            var i = (h.end - h.start) * (g ? h.end : f) + h.start;
            switch (MotionGuidePlugin.calc(h, i, a.target),
            h.orient) {
            case "cw":
            case "ccw":
            case "auto":
    ...
    MotionGuidePlugin.calc = function(a, b, c) {
        ...
        h = 2 * h + 2;
        var l = 1 - k;
        return c.x = l * l * e[h - 2] + 2 * l * k * e[h + 0] + k * k * e[h + 2],
...
function() {
    ...
    a.version = "0.6.2",
    a.buildDate = "Thu, 26 Nov 2015 20:44:31 GMT"
}();
