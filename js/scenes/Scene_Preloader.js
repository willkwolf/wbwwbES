...
function Scene_Preloader(){
	...
	// Loading text
	var text = new PIXI.Text("loading... 0%", {font:"25px Cantarell", fill:"#4C4C4C", align:"center"});
    text.anchor.x = 0.5;
    text.anchor.y = 0.5;
    text.x = bar.x;
    text.y = bar.y;
    ...
    // Warning text
    var warningText = new PIXI.Text(textStrings["warning"], { font: "25px Cantarell", fill: "#666666", align: "center" });
