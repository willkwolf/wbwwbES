...
function Scene_Quote(){
    ...
    var q3Name = new PIXI.Text(textStrings["MarshallMcLuhan"], {font:"33px Cantarell", fill:"#FFFFFF", align:"center"});
    q3Name.anchor.x = 0.5;
    q3Name.anchor.y = 0.5;
